<template>
  <div class="lottery-page">
    ...
    <DateTimeRecommend
      ...
      @prefix-update="handlePrefixUpdate"
      @lunar-update="handleLunarUpdate"
    />
...
export default {
  ...
  methods: {
    ...
    handlePrefixUpdate(newPrefix) {
      //console.log('前缀更新:', newPrefix)
      //newPrefix = 1+newPrefix
      // 可以在这里处理前缀更新逻辑
    },

    handleLunarUpdate(newLunar) {
